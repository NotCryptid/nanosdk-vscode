...
exports.compileNanoSDK = compileNanoSDK;
exports.resolveLocalIconSync = resolveLocalIconSync;
exports.parseIconFileContent = parseIconFileContent;
exports.nsc_tokens = nsc_tokens;
exports.nsc_cmp = nsc_cmp;
exports.nsc_btn = nsc_btn;
exports.nsc_bs = nsc_bs;
exports.nsc_pad = nsc_pad;
const fs = require("fs");
 ...
 */
async function compileNanoSDK(source, options) {
    const errors = [];
    const warnings = [];
 ...
 */
function resolveLocalIconSync(iconParam, sourceFilePath, warnings) {
 ...
 */
function parseIconFileContent(content) {
