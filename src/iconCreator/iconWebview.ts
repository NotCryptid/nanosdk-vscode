...
export const MICROOS_PALETTE: { hexKey: string; color: string; name: string }[] = [
...
export function getIconEditorHtml(fileName: string, initialHexData: string): string {
    const paletteJson = JSON.stringify(MICROOS_PALETTE);
